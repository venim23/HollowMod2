...
import HollowMod.relics.DefaultClickableRelic;
import HollowMod.relics.PlaceholderRelic;
import HollowMod.relics.PlaceholderRelic2;

import java.util.ArrayList;

import static HollowMod.DefaultMod.*;
import static HollowMod.characters.TheDefault.Enums.HOLLOW_COLOR;
...
public class TheDefault extends CustomPlayer {
    ...
    public Color getCardTrailColor() {
        return HollowMod.DefaultMod.BUGKNIGHT_PALE;
    }
    ...
    public Color getCardRenderColor() {
        return HollowMod.DefaultMod.BUGKNIGHT_GRAY;
    }
