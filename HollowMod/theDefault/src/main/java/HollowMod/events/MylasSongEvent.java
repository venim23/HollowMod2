...
import static HollowMod.DefaultMod.makeEventPath;

public class MylasSongEvent extends AbstractImageEvent {


    public static final String ID = DefaultMod.makeID("MylasSongEvent");
    private static final EventStrings eventStrings = CardCrawlGame.languagePack.getEventString(ID);

    private static final String NAME = eventStrings.NAME;
    private static final String[] DESCRIPTIONS = eventStrings.DESCRIPTIONS;
    private static final String[] OPTIONS = eventStrings.OPTIONS;
    public static final String IMG = makeEventPath("MylasSongEvent.png");

    private int screenNum = 0; // The initial screen we will see when encountering the event - screen 0;
	public int mylaEncounter = 0;
