...
public class attackCoiledNail extends AbstractDefaultCard {
    ...
    public static final String IMG = makeCardPath("attackCoiledNail.png");
    ...
    public attackCoiledNail() {// This one and the one right under the imports are the most important ones, don't forget them
