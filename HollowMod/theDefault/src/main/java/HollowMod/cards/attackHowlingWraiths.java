...
public class attackHowlingWraiths extends AbstractDefaultCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with attackHowlingWraiths
    ...
    public static final String ID = DefaultMod.makeID("HowlingWraiths");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("attackHowlingWraiths.png");
