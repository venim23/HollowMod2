...
public class skillQuickDash_s extends AbstractDefaultCard {
    ...
    public static final String ID = DefaultMod.makeID("QuickDashStart"); // DefaultMod.makeID("skillQuickDash_s");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("QuickDash.png");// "public static final String IMG = makeCardPath("skillQuickDash_s.png");
