...
public class attackNailStrike_s extends AbstractDefaultCard {
    ...
    public static final String ID = DefaultMod.makeID("NailStrikeStart"); // DefaultMod.makeID("attackNailStrike");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = makeCardPath("NailStrike.png");// "public static final String IMG = makeCardPath("attackNailStrike.png");
