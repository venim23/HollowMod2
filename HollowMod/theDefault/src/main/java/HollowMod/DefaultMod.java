...
public class DefaultMod implements
    ...
    private static final String THE_BUGKNIGHT_PORTRAIT = "HollowModResources/images/charSelect/BugKnightPortraitBG.png";
    ...
    public DefaultMod() {
        ...
        logger.info("Creating the color " + TheDefault.Enums.HOLLOW_COLOR.toString());

        BaseMod.addColor(TheDefault.Enums.HOLLOW_COLOR, BUGKNIGHT_GRAY, BUGKNIGHT_GRAY, BUGKNIGHT_GRAY,
    ...
    public void receiveEditCharacters() {
        logger.info("Beginning to edit characters. " + "Add " + TheDefault.Enums.THE_BUGKNIGHT.toString());

        BaseMod.addCharacter(new TheDefault("the Bug Knight", TheDefault.Enums.THE_BUGKNIGHT),
                THE_BUGKNIGHT_BUTTON, THE_BUGKNIGHT_PORTRAIT, TheDefault.Enums.THE_BUGKNIGHT);

        receiveEditPotions();
        logger.info("Added " + TheDefault.Enums.THE_BUGKNIGHT.toString());
    }
    ...
    public void receiveEditPotions() {
        ...
        BaseMod.addPotion(PlaceholderPotion.class, PLACEHOLDER_POTION_LIQUID, PLACEHOLDER_POTION_HYBRID, PLACEHOLDER_POTION_SPOTS, PlaceholderPotion.POTION_ID, TheDefault.Enums.THE_BUGKNIGHT);
